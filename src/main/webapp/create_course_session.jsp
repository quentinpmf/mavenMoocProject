  ...
  <body>
    ...
    <div class="container">
        ...
        <h1 class="my-4">Création
          <small>d'une session de formation</small>
        </h1>
            ...
            <div class="col-md-6">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                      <label for="filter">Choix de la formation</label>
                    ...
                    <div class="form-group">
                        <label for="contain">Date de début de la formation</label>
                        <input class="form-control" type="date" name="startDate"/>
                    </div>
                    <div class="form-group">
                        <label for="contain">Date de fin de la formation</label>
                        <input class="form-control" type="date" name="endDate" />
                    </div>
                    <div class="form-group">
                      <label for="filter">Nombre de places maximum</label>
                      <input type="text" class="form-control" name="maxi">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="divCreateFormationButton">
                        <button class="btn btn-success" type="submit" >Créer une session de formation</button>
                    </div>
                </form>
            </div>
